angular.module('sheepWeb.service', []).factory('news', function() {
  return [
    {
...
}).factory('generation', function() {
  return [
    {
      index: "1",
      name: "一代目",
      discription: "Sheep創立メンバー+2007年度生",
      num: "**",
      active: false
    }, {
      index: "2",
    ...
    items: [
      {
        ...
        name: "リング",
        discription: "輪っかです。投げたり回したり首にかけたりします。風に弱いので外での使用は難しいです。",
        image: "ring.jpg"
      }, {
        name: "クラブ",
        discription: "こん棒です。トス系(投げるタイプのジャグリング)の花形とも言える道具です。回転が付くので操るのは難しいです。複数人でパスしたりもします。",
        image: "club.jpg"
      }, {
        name: "シガーボックス",
        discription: "箱です。基本的に3つ同時に使います。外側の2つを持って操ります。想像以上に疲れます。",
        image: "box.jpg"
      }, {
        name: "デビルスティック",
        discription: "棒です。手に持った2本の棒で真ん中の長い棒を操ります。棒の先にフサフサのついた物はフラワースティックと呼ばれます。演者は頑張ってますが意外と地味です。",
        image: ""
      }, {
        name: "ディアボロ",
        discription: "こまです。お椀を2つくっつけた様な形のコマ。糸で回転をつけて操ります。見た目も派手で、見ていて非常に楽しいです。一度に2つ以上回す事が出来る人もいるとか。",
        image: "diabolo.jpg"
      }, {
        name: "スピニングプレート",
        discription: "皿です。回します。いわゆる皿回しです。",
        image: "plate.jpg"
      }, {
        name: "シェーカーカップ",
        discription: "カップです。カップがカップに入ります。",
        image: ""
      }, {
        name: "ハット",
        discription: "帽子です。投げたり転がしたりかぶったりします。",
        image: "hat.jpg"
      }, {
        name: "コンタクト",
        discription: "水晶玉です。玉が浮いているかのように操ります。",
        image: "contact.jpg"
      }, {
        name: "アイソレーションフープ",
        discription: "また輪っかです。輪っかが気持ち悪い動きをします。",
        image: ""
      }, {
        name: "ポイ",
        discription: "ポイです。振り回します。音楽に合わせて踊るように操ります。たまに投げたり転がしたりします。",
        image: "poi.jpg"
      }, {
        name: "スタッフ",
        discription: "棒です。振り回します。迫力満点に操ります。たまに手で持たずに振り回したりします。",
        image: ""
      }, {
        name: "バルーン",
        discription: "風船です。いろんな物を作ります。基本的にはポンプで膨らましますが、人によっては口で膨らまします。",
        image: "120409_1352001.jpg"
      }
    ]
  };
});

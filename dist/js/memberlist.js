angular.module('sheepWeb.member', [], function($provide) {
  return $provide.factory('memberList', function() {
    return {
      config: {
        url: "img/member/"
      },
        ...
        2: [
          {
            ...
            name: "かなこ",
            item: "コンタクト",
            discription: "Sheepの女神と目される女性。            マジックの経験から、立ち振舞が鮮やかである。",
            image: "../shoboon.jpg"
          }
        ],
        3: [
          {
            ...
            discription: "Sheep音ゲー部部長兼3代目代表。            弐寺皆伝の腕前は流石の一言。",
            image: "3rd/utkr.png"
          }, {
            name: "ゆーてん",
            item: "クラブ, ナイフ, maimai",
        ...
        4: [
          {
            ...
            name: "あつみん",
            item: "ボール",
            discription: "かつて「うらあつ」という奇跡のキモい系ジャグリングコンビの片翼を担っていた            ソロパフォーマンスはどうなるのか……",
            image: "4th/atm4.png"
          }, {
            name: "iinm",
            item: "デビル",
        ...
        5: [
          {
            name: "らてふ",
            item: "ボール, ディア, クラブ",
            discription: "5代目代表!そしてSheep厄介部ぶちょう。            カメラを向ければ常にキメ顔",
            image: "5th/ymuc4.jpg",
            detail: "ymuc"
          }, {
            name: "うじみー",
